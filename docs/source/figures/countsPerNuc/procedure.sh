echo ".. figure::"
for fileName in /data2/rivasas2/singleNucleosome/secondBatch/counts/counts_per_nucleosome/distance_from_exon_overExpected/AS/canonicalNuc_*_1.nuc_avrcov.svg; do
ln -s $fileName .
...
for histone in 8_mnase H3K4me3 H3K27Ac H3K9me3 H3K27me3; do
for fileName in $(ls /data2/rivasas2/singleNucleosome/secondBatch/counts/counts_per_nucleosome/ref_nuc_pos_overExpected/boxplots/*.svg | grep $histone );do
ln -s $fileName .
name=$(echo $fileName | awk '{n=split($0,a,"/");print a[n]}')
echo ".. image:: https://132.239.135.28/public/nucChIP/files/countsPerNuc/$name"
echo "   :width: 45%"
