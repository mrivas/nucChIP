...
def main():
	...
	#libSize=mnaseChIP.getLibSize(bamName)
	libSize=20000000
	print "Getting nucleosomes"
	nucl_ivs = mnaseChIP.getNuclIV(nuclFile,halfwin)
	...
	coverage = mnaseChIP.getFullCoverage(avrLength,bamFile,halfRead)
	print "Producing average and matrix profiles"
	average,matrix = mnaseChIP.getProfiles(coverage,halfwin,nucl_ivs,libSize)
	print "Plotting results"
	#mnaseChIP.getPlots(out,average,matrix,halfwin)
